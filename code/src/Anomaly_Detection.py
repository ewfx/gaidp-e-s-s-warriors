...
def generate_report(original_data, cleaned_data, outliers_data):
    ...
    plt.savefig("outlier_removal_visualization.png")
    plt.show()
    
if __name__ == "__main__":
    file_path = "Online_Sales.csv"  # Change this to your dataset path
    ...
    outliers_data.to_csv("removed_outliers.csv", index=False)
